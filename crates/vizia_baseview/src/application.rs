...
impl ApplicationRunner {
    ...
    pub fn on_frame_update(&mut self, window: &mut Window) {
            ...
            || *cx.user_scale_factor() != self.current_user_scale_factor
        {
            ...
            // TODO: Implement this on Windows and macOS as well
            #[cfg(not(target_os = "linux"))]
            eprintln!("Window resizing has not yet been implemented for this platform");

            // The user scale factor is not part of the HiDPI scaling, so baseview should treat
            // it as part of our logical size
            #[cfg(target_os = "linux")]
            {
                ...
                // TODO: These calculations are now repeated in three places, should probably be
                //       moved to a function
                ...
                // After the window is resized, we should let every view know about this so they can
                // act accordingly
                cx.0.emit_custom(
                ...
                self.event_manager.flush_events(&mut cx.context());
            }
        }
